...
static const char *const yytname[] =
{
  ...
  "NUMBER", "ASSIGN", "SEMICOLON", "PLUS", "MINUS", "TIMES", "DIVIDE",
  "LPAREN", "RPAREN", "$accept", "program", "declaration", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* declaration: INT IDENTIFIER ASSIGN NUMBER SEMICOLON  */
#line 30 "parser.y"
      {
