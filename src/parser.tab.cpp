...
static const char *const yytname[] =
{
  ...
  "SEMICOLON", "PLUS", "MINUS", "TIMES", "DIVIDE", "LPAREN", "RPAREN",
  ...
  "COMMA", "INC", "DEC", "PRINT", "NUMBER", "IDENTIFIER", "STRING",
...
{
      -1,   -38,    -8,     3,    10,    -1,   -38,   -38,   -38,   -38,
      -1,   -37,   -10,   -38,   -38,    -4,    25,    28,    -7,   -38,
     -38,    16,    18,   -38,    36,    37,    11,   -38,   -38,    -7,
      -7,    -7,    -7,   -38,   -38,   -38,    20,    20,   -38,   -38
};
...
static const yytype_int8 yydefact[] =
{
      ...
      13,     0,     0,     9,     0,     0,     0,    11,    10,     0,
       0,     0,     0,    20,    19,    18,    14,    15,    16,    17
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -38,   -38,    33,     1,   -38,   -38,   -38,   -17,   -38
};
...
{
      18,    26,    11,    18,    16,    17,    14,    12,     1,    23,
      13,     1,    36,    37,    38,    39,    14,    29,    30,    31,
      32,    27,    35,    28,    29,    30,    31,    32,    31,    32,
      19,    20,    21,    19,    20,     2,    24,     3,     2,    25,
       3,    33,    34,    15
};

static const yytype_int8 yycheck[] =
{
      10,    18,    10,    10,    41,    42,     5,     4,    12,    13,
       0,    12,    29,    30,    31,    32,    15,     6,     7,     8,
       9,     5,    11,     5,     6,     7,     8,     9,     8,     9,
      40,    41,    42,    40,    41,    39,    11,    41,    39,    11,
      41,     5,     5,    10
};
...
{
       0,    12,    39,    41,    44,    45,    46,    47,    49,    51,
      48,    10,     4,     0,    46,    45,    41,    42,    10,    40,
      41,    42,    50,    13,    11,    11,    50,     5,     5,     6,
       7,     8,     9,     5,     5,    11,    50,    50,    50,    50
};
...
#line 86 "src/parser.y"
    {
        if(!symbolTable.exists((yyvsp[-3].sval))){
            Symbol s;
            s.type = "int";
            s.data = (yyvsp[-1].expr)->code;

            symbolTable.add((yyvsp[-3].sval),s);

            code_out << "Value " << (yyvsp[-3].sval) << " = " << (yyvsp[-1].expr)->code << ";\n";
        } else{
